...
const Signup = () => {
  ...
  return (
    <div className="h-full flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h2 className="mt-6 text-center text-2xl font-bold tracking-tight text-gray-900">
          Sign up for Soulful Sojourns
        </h2>
      </div>
        ...
        <div className="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
          ...
          <div>
            ...
            <div className="mt-6 flex justify-center">
              <button
                className="flex w-1/2 items-center justify-center gap-3 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
              >
