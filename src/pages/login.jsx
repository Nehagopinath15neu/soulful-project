  ...
  return (
    <div className="flex min-h-screen">
          ...
          <div className="mt-10">
            ...
            <div className="mt-10">
              ...
              <div className="mt-6 flex justify-center">
                <a href="#" className="flex w-1/2 items-center justify-center gap-3 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus-visible:ring-transparent">
      ...
      <div className="relative hidden w-0 flex-1 lg:block">
        <img className="absolute inset-0 h-full w-full object-cover" src={loginImage} alt="" />
      </div>
    </div>
  );
};
